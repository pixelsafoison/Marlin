...
#define STRING_CONFIG_H_AUTHOR "Folny Axel" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Baphomet"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  36.09,  22.20 }
    #define DEFAULT_Ki_LIST {   3.35,   1.08 }
    #define DEFAULT_Kd_LIST { 97.12, 114.00 }
  #else
    #define DEFAULT_Kp  36.09
    #define DEFAULT_Ki   3.35
    #define DEFAULT_Kd 97.12
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 15, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, 15, 0 }
...
#define PREHEAT_3_LABEL       "90°C BED"
